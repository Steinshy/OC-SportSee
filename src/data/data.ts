...
export const USER_MAIN_DATA: DataModule['USER_MAIN_DATA'] = [
  {
    id: 12,
    userInfos: {
      firstName: 'Karl',
...
export const USER_ACTIVITY: DataModule['USER_ACTIVITY'] = [
  {
    userId: 12,
    sessions: [
...
export const USER_AVERAGE_SESSIONS: DataModule['USER_AVERAGE_SESSIONS'] = [
  {
    userId: 12,
    sessions: [
...
export const USER_PERFORMANCE: DataModule['USER_PERFORMANCE'] = [
  {
    userId: 12,
    kind: {
      1: 'cardio',
