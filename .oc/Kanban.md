...
## User Story #1 — Navigation horizontale

En tant qu'utilisateur, je veux pouvoir accéder à un menu de navigation horizontale. Située en haut de l'écran, ce menu me permettra de naviguer entre les différents écrans de mon application.

## User Story #2 — Navigation verticale

En tant qu'utilisateur, je veux pouvoir accéder à un menu de navigation verticale. Située sur la gauche et composé d'icônes, il me permet de naviguer entre les futures blocs de navigation.

## User Story #3 — Taille d'écran
...
## User Story #5 — Infos utilisateur
...
## User Story #6 — Activité quotidienne
...
## User Story #7 — Durée sessions

En tant que développeur, je veux pouvoir accéder à la durée moyenne des sessions via la route `/user/:id/average-sessions`. Cette route donne des informations sur la durée moyenne des sessions.

## User Story #8 — Complétion objectif

En tant que développeur, je veux pouvoir accéder à la complétion de l'objectif de la journée via la route `/user/:id`. Cette route donne des informations sur la complétion de l'objectif journalier.

## User Story #9 — Types d'activité
...
## User Story #10 — Chiffres clés

En tant que développeur, je veux pouvoir accéder aux chiffres clés via la route `/user/:id/activity`. Cette route me donne des informations sur les calories, protéines, glucides et lipides de la journée.
