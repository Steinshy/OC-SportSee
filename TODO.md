...
- [x] **Documentation** — Create comprehensive README
  - Project overview and setup instructions
  - Installation steps (npm install, npm run dev)
  - Available scripts and build commands
  - Project structure and architecture overview
  - Description of key features (15 user stories)
  - API integration details (mock vs real API)
  - Chart components overview (Recharts)
  - Bilingual documentation (French & English with language switcher)

## Layout & Navigation

- [x] **US#1 — Horizontal nav bar**
...
- [x] **US#3 — Desktop layout (min 1024x780)**
...
- [x] **TypeScript types** — define interfaces for all API response shapes
...
- [x] **US#5 — Fetch user info** — `GET /user/:id`
...
- [x] **US#6 — Fetch daily activity** — `GET /user/:id/activity`
  - Returns: `sessions[]` with `day`, `kilogram`, `calories`

- [x] **US#7 — Fetch average sessions** — `GET /user/:id/average-sessions`
  - Returns: `sessions[]` with `day` (1-7), `sessionLength` (minutes)

- [x] **US#9 — Fetch performance** — `GET /user/:id/performance`
...
- [x] **US#10 — Extract key figures from user info**
...
- [x] **US#12 — LineChart: Durée moyenne des sessions**
...
- [x] **US#13 — RadarChart: Type d'activité**
...
- [x] **US#15 — Key info cards** (right sidebar, 4 cards stacked vertically)
...
## Future Sprints (Out of Scope — Current Sprint)
